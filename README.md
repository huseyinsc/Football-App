...
- **Multi-User Reservations:** Support for team bookings where multiple players can join the same pitch reservation.
- **Enhanced Domain Model:** Proper JPA relationships with ReservationParticipant junction entity.
- **Complete API Coverage:** Added PitchController and UserController for full CRUD operations.
